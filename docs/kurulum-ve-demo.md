...
<!-- GÖRSEL: docs/screenshots/01-login.png — login ekranı -->
<!-- GÖRSEL: docs/screenshots/02-hasta-listesi.png — hasta rollup listesi, worst-status rozetleri -->
...
<!-- GÖRSEL: docs/screenshots/03-arama-onerileri.png — "p-" yazınca çıkan öneriler -->
<!-- GÖRSEL: docs/screenshots/04-gelismis-filtreler.png — açılmış filtre paneli -->
...
<!-- GÖRSEL: docs/screenshots/05-tup-detay.png — tüp kartları, anormal testler üstte, referans bar -->
...
<!-- GÖRSEL: docs/screenshots/06-trend-sparkline.png — tek testin trend grafiği -->
...
<!-- GÖRSEL: docs/screenshots/07-ai-loading.png — "Analiz ediliyor…" durumu -->
<!-- GÖRSEL: docs/screenshots/08-ai-analizi.png — özet + flaggedTests + takip + disclaimer -->
...
<!-- GÖRSEL: docs/screenshots/09-dark-mode.png — aynı ekran karanlık temada -->
<!-- GÖRSEL: docs/screenshots/10-toast.png — toast bildirimi görünürken -->
...
<!-- GÖRSEL: docs/screenshots/12-audit-log.png — audit log JSON cevabı -->
...
<!-- GÖRSEL: docs/screenshots/11-swagger.png — Swagger UI, endpoint listesi + Authorize -->
...
<!-- GÖRSEL: docs/screenshots/13-ci-success.png — GitHub Actions CI yeşil -->
