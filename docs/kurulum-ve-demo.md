...
- [Docker Desktop](https://docs.docker.com/get-started/introduction/get-docker-desktop/) ve
  **Docker Compose** çalışır durumda.
...
- `gemma2:9b` için en az **16 GB sistem belleği önerilir**; daha düşük bellekte model yavaşlayabilir
  veya çalışmayabilir.
...
uygulamayı host'ta ayağa kaldırın. Bu yöntem için ayrıca **Java 17** ve **Node.js 22** gerekir.
İlk kez inceleyen veya Windows kullanan bir değerlendirici için tam Docker yöntemi daha sadedir.
